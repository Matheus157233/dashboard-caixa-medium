...
CLIENTES = {
    ...
    "IpipqBrasil": {
        "senha_hash": _h("Ipipqbrasil2026"), "nome": "Empresa Demo Empresarial",
...
PLANOS = {
    "basico":       {"fluxo", "pizza"},
    "profissional": {"fluxo","pizza","barras","mensal","top","tabela","filtro_avancado"},
    "empresarial":  {"fluxo","pizza","barras","mensal","top","tabela","filtro_avancado",
